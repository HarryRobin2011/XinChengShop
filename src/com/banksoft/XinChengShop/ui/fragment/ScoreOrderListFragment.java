...
import com.banksoft.XinChengShop.adapter.ScoreOrderListAdapter;
 ...
 */
public class ScoreOrderListFragment extends XCBaseListFragment{
    ...
    public void request() {
        ...
        bailaAdapter = new ScoreOrderListAdapter(mContext,new ArrayList());
        setListDao();
    }
