package com.banksoft.XinChengShop.widget.dropdown;
...
public class DropdownView extends RelativeLayout {
    ...
    private void initParams(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mArrowDownDrawable == null) {
            mArrowDownDrawable = getResources().getDrawable(R.drawable.ic_arrow_down);
        }
        if (mArrowDownDrawable != null) {
        ...
        if (mArrowUpDrawable == null) {
            mArrowUpDrawable = getResources().getDrawable(R.drawable.ic_arrow_up);
        }
        if (mArrowUpDrawable != null) {
