...
public abstract class DataBaseColumn {
    public static final String[] columns = new String[]{CacheColumn.class.getName(),LoginInfoColumn.class.getName(), CountyColumn.class.getName(), CityColum.class.getName(), ProvinceColumn.class.getName()};
